...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    ...
    if (filter === 'high') {
        filtered = affairs.filter((el) => el.priority === 'high')
    }
    if (filter === 'middle') {
        filtered = affairs.filter((el) => el.priority === 'middle')
    }
    if (filter === 'low') {
        filtered = affairs.filter((el) => el.priority === 'low')
    }

    return filtered // need to fix
}
